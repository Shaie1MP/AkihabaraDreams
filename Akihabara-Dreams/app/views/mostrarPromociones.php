    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            <div class="admin-header">
                ...
                <p>Administra las promociones de la tienda</p>
            </div>

            <div class="admin-create-button">
                <a href="/Akihabara-Dreams/promociones/crear" class="admin-btn admin-btn-primary">
            ...
            <div class="admin-table-container">
                <div class="admin-table-header">
                    <h2 class="admin-table-title">Lista de Promociones</h2>
                </div>
                <?php
                include '../app/includes/generarPromociones.php';
                ?>
            </div>
        </div>
    </div>
