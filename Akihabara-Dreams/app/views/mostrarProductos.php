    ...
    <div class="admin-container">
        ...
        <div class="admin-sidebar">
            ...
            <ul class="admin-sidebar-menu">
                ...
                <li class="admin-sidebar-item">
                    <a href="/Akihabara-Dreams/productos" class="admin-sidebar-link active">
                        <span class="admin-sidebar-icon">
        ...
        <div class="admin-content">
            ...
            <div class="admin-create-button">
                <a href="/Akihabara-Dreams/productos/crear" class="admin-btn admin-btn-primary">
            ...
            <div class="admin-table-container">
                <div class="admin-table-header">
                    <h2 class="admin-table-title">Lista de Productos</h2>
                </div>
                <?php
