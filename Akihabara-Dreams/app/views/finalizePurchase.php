...
include '../app/includes/decryptCookies.php';
...
<head>
    ...
    <script src="/Akihabara-Dreams/resources/js/validate-card.js"></script>
</head>
    ...
    <div class="checkout-container">
        ...
        <div class="checkout-content">
            ...
            <div class="shipping-info">
                ...
                <form id="order-form" action="/Akihabara-Dreams/orders/create" method="POST">
