    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            ...
            <div class="admin-create-button">
                <a href="/Akihabara-Dreams/usuarios/crear" class="admin-btn admin-btn-primary">
            ...
            <div class="admin-table-container">
                <div class="admin-table-header">
                    <h2 class="admin-table-title">Lista de Usuarios</h2>
                </div>
                <?php
                // Añadir código de depuración para verificar si hay usuarios
