...
<head>
    ...
    <title>Promociones - Akihabara Dreams</title>
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            <div class="admin-header">
                <h1><?php echo __('admin_promotion_management')?></h1>
                <p><?php echo __('admin_shop_promotions')?></p>
            </div>

            <div class="admin-create-button">
                <a href="/Akihabara-Dreams/promotions/crear" class="admin-btn admin-btn-primary">
            ...
            <div class="admin-table-container">
                <div class="admin-table-header">
                    <h2 class="admin-table-title"><?php echo __('admin_promotions_list')?></h2>
                </div>
                <?php
                include '../app/includes/generatePromotions.php';
                ?>
            </div>
        </div>
    </div>
