...
if (!isset($userSession) && isset($_SESSION['usuario'])) {
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            <div class="admin-header">
                <h1><?php echo __('admin_update_user'); ?></h1>
                <p><?php echo __('admin_modify_user'); ?></p>
            </div>

            <div class="admin-form-container">
                <?php
                if (isset($user)) {
                    include '../app/includes/generateFormUpdateUser.php';
                }
                ?>
            </div>
        </div>
