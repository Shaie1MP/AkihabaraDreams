...
<head>
    ...
    <title>Usuarios - Akihabara Dreams</title>
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            <div class="admin-header">
                <h1><?php echo __('admin_user_management')?></h1>
                <p><?php echo __('admin_platform_users')?></p>
            </div>

            <div class="admin-create-button">
                <a href="/Akihabara-Dreams/users/crear" class="admin-btn admin-btn-primary">
                    ...
                    <?php echo __('admin_add_user')?>
                </a>
            </div>

            <div class="admin-table-container">
                <div class="admin-table-header">
                    <h2 class="admin-table-title"><?php echo __('admin_users_list')?></h2>
                </div>
                <?php
                if (!isset($users) || empty($users)) {
                    echo '<div style="padding: 1rem; text-align: center;">No hay usuarios para mostrar o la variable $users no está definida.</div>';
                }
                include '../app/includes/generateUsers.php';
                ?>
            </div>
        </div>
    </div>
