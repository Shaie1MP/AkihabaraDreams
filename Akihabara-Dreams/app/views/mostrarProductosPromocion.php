    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            ...
            <div class="admin-actions">
                <a href="/Akihabara-Dreams/promociones/productos/<?= $promotion->getId() ?>/agregar" class="admin-btn admin-btn-primary">
                ...
                <a href="/Akihabara-Dreams/promociones" class="admin-btn admin-btn-secondary">
            ...
            <?php include '../app/includes/generarProductosPromocion.php'; ?>
        </div>
    </div>
</body>
</html>