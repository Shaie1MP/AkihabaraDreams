    ...
    <div class="admin-container">
            ...
            <ul class="admin-sidebar-menu">
                ...
                <li class="admin-sidebar-item">
                    <a href="/Akihabara-Dreams/" class="admin-sidebar-link">
                        <span class="admin-sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width  width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-store">
        ...
        <div class="admin-content">
            <div class="admin-header">
                ...
                <p>Añade una nueva promoción a la tienda</p>
            </div>

            <div class="admin-form-container">
                <form action="/Akihabara-Dreams/promociones/create" method="post" class="admin-form">
                    ...
                    <div class="admin-form-actions">
                        <button type="submit" class="admin-btn admin-btn-primary">Crear Promoción</button>
