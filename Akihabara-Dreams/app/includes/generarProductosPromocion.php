                ...
                foreach ($products as $product) {
                    ...
                    echo "<td>
                            <div class='admin-table-actions'>
                                <a href='/Akihabara-Dreams/productos/info/" . $product->getId() . "' class='admin-btn admin-btn-secondary' title='Ver producto'>
                                ...
                                <a href='/Akihabara-Dreams/promociones/productos/" . $promotion->getId() . "/eliminar/" . $product->getId() . "' class='admin-btn admin-btn-danger' title='Eliminar de la promoción' onclick=\"return confirm('¿Estás seguro de que deseas eliminar este producto de la promoción?');\">
