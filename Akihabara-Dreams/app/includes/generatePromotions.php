    ...
    <table class="admin-table">
        <thead>
            <tr>
                ...
                <th><?php echo __('admin_promotion_code')?></th>
                <th><?php echo __('admin_promotion_discount')?></th>
                <th><?php echo __('admin_promotion_description')?></th>
                <th><?php echo __('admin_promotion_start_date')?></th>
                <th><?php echo __('admin_promotion_end_date')?></th>
                <th><?php echo __('admin_promotion_status')?></th>
                ...
                foreach ($promotions as $promotion) {
                    ...
                    echo "<td>
                            <div class='admin-table-actions'>
                                <a href='/Akihabara-Dreams/promotions/productos/" . $promotion->getId() . "' class='admin-btn admin-btn-secondary' title='Ver productos'>
                                ...
                                <a href='/Akihabara-Dreams/promotions/editar/" . $promotion->getId() . "' class='admin-btn admin-btn-primary' title='Editar'>
                                ...
                                <form action='/Akihabara-Dreams/promotions/eliminar/" . $promotion->getId() . "' method='POST' style='display:inline;'>
