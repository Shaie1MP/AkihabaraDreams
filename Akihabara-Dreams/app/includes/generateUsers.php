    ...
    <table class="admin-table">
        <thead>
            <tr>
                ...
                <th><?php echo __('admin_user_profile_pic')?></th>
                <th><?php echo __('admin_user_username')?></th>
                <th><?php echo __('admin_user_name')?></th>
                <th><?php echo __('admin_user_email')?></th>
                <th><?php echo __('admin_user_phone')?></th>
                <th><?php echo __('admin_user_addresses')?></th>
                <th><?php echo __('admin_user_role')?></th>
                <th><?php echo __('admin_user_actions')?></th>
            </tr>
        </thead>
        <tbody>
            <?php
                ...
                foreach ($users as $user) {
                    ...
                    echo '<td>
                            <div class="admin-table-actions">
                                <a href="/Akihabara-Dreams/users/actualizar/'.$user->getId().'" class="admin-btn admin-btn-primary">
                                ...
                                <form action="/Akihabara-Dreams/users/eliminar/'.$user->getId().'" method="POST" style="display:inline;">
