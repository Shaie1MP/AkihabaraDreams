...
<div class="search-bar">
    <input type="text" name="search" id="search" placeholder="Buscar mangas...">
    <div>
...
<script>
    const totalProducts = <?php echo $mangaCount; ?>;
</script>
